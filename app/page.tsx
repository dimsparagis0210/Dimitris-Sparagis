...
export default function MyApp() {
    ...
    return (
        <>
        <div className={`homeContainer relative bg-myWhite min-h-screen flex flex-col gap-[10rem]`}>
            ...
            <main className={`flex font-bold justify-center`}>
                <section className={`flex flex-col text-center z-[2] py-[8rem] text-4xl 3xs:text-5xl xs:text-7xl md:text-9xl`}>
                    <p>DIMITRIS</p>
                    <p>SPARAGIS</p>
                </section>
